...
java -cp $CLASSPATH -Djava.net.preferIPv4Stack=true org.apache.hadoop.hdfs.server.namenode.NNThroughputBenchmark -op blockReport -datanodes 1024 -reports 1 -blocksPerReport 1000 -blocksPerFile 1
