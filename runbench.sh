...
java -cp $CLASSPATH -Djava.net.preferIPv4Stack=true org.apache.hadoop.hdfs.server.namenode.NNThroughputBenchmark -op blockReport -datanodes 64 -reports 1 -blocksPerReport 20000 -blocksPerFile 1000
